...
%twelve hour to four hour transistions
     ...
     xpoint1= expxpoint(1);
        ...
        multi.Hilighttimes1 = Hilighttimes(twlightidx1);
        multi.hixx1 = hixx(twidx1);
        multi.Hifftyy1 = Hifftyy(twidx1);
        multi.Lofftyy1 = Lofftyy(twidx1);
        multi.loxx1 = loxx(twidx1);
       ...
       lotimidx1 = find(LoTim >= xpoint1 & LoTim <= (xpoint1 + 48));
        ...
        multi.LoAmp = LoAmp;
        multi.HiTim1 = HiTim(hitimidx1);
        multi.LoTim1 = LoTim(lotimidx1);
     ...
     %third transition - expecting 12 hours light, get 4
       xpoint2 = expxpoint(2);
        ...
        multi.Hilighttimes2 = Hilighttimes(twlightidx2);
        multi.hixx2 = hixx(twidx2);
        multi.Hifftyy2 = Hifftyy(twidx2);
        multi.Lofftyy2 = Lofftyy(twidx2);
        multi.loxx2 = loxx(twidx2);
       ...
       lotimidx2 = find(LoTim >= xpoint2 & LoTim <= (xpoint2 + 48));
        ...
        multi.HiTim2 = HiTim(hitimidx2);
        multi.LoTim2 = LoTim(lotimidx2);
   ...
   %four hour to twelve hour transitions 
     ...
     xpoint3 = expxpoint(3);
        ...
        multi.Hilighttimes3 = Hilighttimes(twlightidx3);
        multi.hixx3 = hixx(twidx3);
        multi.Hifftyy3 = Hifftyy(twidx3);
        multi.Lofftyy3 = Lofftyy(twidx3);
        multi.loxx3 = loxx(twidx3);
       ...
       lotimidx3 = find(LoTim >= xpoint3 & LoTim <= (xpoint3 + 48));
        ...
        multi.HiTim3 = HiTim(hitimidx3);
        multi.LoTim3 = LoTim(lotimidx3);
      ...
      %fourth transition - 4 hours to 12 hours
       ...
       xpoint4 = expxpoint(4);
        ...
        multi.Hilighttimes4 = Hilighttimes(twlightidx4);
        multi.hixx4 = hixx(twidx4);
        multi.Hifftyy4 = Hifftyy(twidx4);
        multi.Lofftyy4 = Lofftyy(twidx4);
        multi.loxx4 = loxx(twidx4);
       ...
       lotimidx4 = find(LoTim >= xpoint4 & LoTim <= (xpoint4 + 48));
        ...
        multi.HiTim4 = HiTim(hitimidx4);
        multi.LoTim4 = LoTim(lotimidx4);
