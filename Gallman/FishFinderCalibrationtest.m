...
%     
        for j = 1:length(hifishchunk1idx)
            hitube2ampchunk1(j) = hitube2ampff(hifishchunk1idx(j))*2.7;
...
%     
        for j = 1:length(hitube1timff)
            hitube1ampchunk2(j) = hitube1ampff(j)*1.5;
            hitube1timchunk2(j) = hitube1timff(j);
