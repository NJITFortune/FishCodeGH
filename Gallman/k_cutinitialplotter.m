...
ax(4) = subplot(514); hold on; title('frequency (black) and temperature (red)');   
        yyaxis right; plot([out.e(2).s.uncuttimcont]/(60*60), [out.e(2).s.fftFreq], '.k', 'Markersize', 8);
        yyaxis right; plot([out.e(1).s.uncuttimcont]/(60*60), [out.e(1).s.fftFreq], '.k', 'Markersize', 8);
        yyaxis left; plot([out.e(2).s.uncuttimcont]/(60*60), [out.e(2).s.temp], '-r', 'Markersize', 8);
        yyaxis left; plot([out.e(1).s.uncuttimcont]/(60*60), [out.e(1).s.temp], '-r', 'Markersize', 8);
    
ax(5) = subplot(515); hold on; title('light transitions');
    plot([out.e(2).s.uncuttimcont]/(60*60), [out.e(1).s.light], '.', 'Markersize', 8);
    ylim([-1, 6]);
    xlabel('Continuous');
...
xa(4) = subplot(514); hold on; title('frequency (black) and temperature (red)'); 
    yyaxis right; plot([out.e(2).s.uncuttim24]/(60*60), -[out.e(2).s.temp], '.');
    yyaxis left; ylim([200 800]);
        plot([out.e(2).s.uncuttim24]/(60*60), [out.e(2).s.fftFreq], '.', 'Markersize', 8);      
    
xa(5) = subplot(515); hold on; title('light transitions');
    plot([out.e(2).s.uncuttim24]/(60*60), [out.e(1).s.light], '.', 'Markersize', 8);
    xlabel('24 Hour');
    ylim([-1, 6]);
