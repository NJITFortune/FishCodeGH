function hourpeak = k_pwelcher(in, ReFs, p, hourperiod)
...
hourpeak(j) = mean(pw(j).zAmp.pxx(ppw(j).zAmp.pfreq > ((1/(2*hourperiod)) - range/2) & pw(j).zAmp.pfreq < ((1/(2*hourperiod)) + range/2)));
end
