function [newtim, newfreqFilled, newampFilled] = k_regularmetamucil(oldtim, oldamp, rawtim, rawamp, rawfreq, regularinterval, lighttimes)
...
if oldtim(1) > rawtim(1) %if first peak starts after tim(1)
    ...
    oldfreq = [rawfreq(1)  NaN(1,length(gapidx)-1,'single') rawfreq];
