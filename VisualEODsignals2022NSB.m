...
% Summed signal with AM
    ...
    title('BEAT: Amplitude Modulation')
...
figure(5); clf;
 ...
 hS3 = sin(tim*395*2*pi) * 0.9; % Fish #3 - 355 Hz and 75% of amplitude of fish #1
    ...
    title('Three Fish Envelope - 300 / 350 / 395 Hz')
