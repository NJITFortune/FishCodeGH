...
% posposIDX = [15 16 17 26 48 51 52]; % original - but maybe error? (48 -> 49; 51 -> 53)
% 3,1 3,2 3,3 4,6 8,5? 9,2 9,3 
posposIDX = [15 16 17 26 49 52 53];
% 3,1 3,2 3,3 4,6 8,6 9,3 9,4 

%negnegIDX = [18 19 20 45 46]; % original - but maybe error (45 -> 47)
% 3,4 3,5 3,6 8,2 8,3
negnegIDX = [18 19 20 46 47]; % original - but maybe error (45 -> 47)
% 3,4 3,5 3,6 8,3 8,4
...
allotherIDX = [1 2 3 5 7 8 10 11 12 14 21 22 23 24 25 26 27 28 31 32 33 34 35 37 39 43 44 45 48 50 51 54 56 57 60 66 69 70 71 72 73];
